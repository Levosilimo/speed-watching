...
// ── Measured-rate provider protocol (docs/provider-integration.md) ───────
// Cross-extension wpm:get: a partner's request travels background → bridge
// → window channel → MAIN-world answer from the measurement context. Data
// minimization: no videoId and no URL in the response.
