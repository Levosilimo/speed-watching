...
harness.run("unreachable recommendation never applies", function()
  select_track(unreachable_srt)
  reset()
  stub.bindings["speed-watcher-apply"]()
  assert_eq(#stub.applied, 0, "unreachable apply is skipped")
  assert_close(stub.speed, 1.0, 1e-9, "speed untouched")
  stub.speed_observer("speed", 1.0)
  assert_eq(#stub.applied, 0, "unarmed sentinel stays quiet")
end)
